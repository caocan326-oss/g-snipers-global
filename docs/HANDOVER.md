...
最后更新：2026-08-27 10:12（公司。§4.29 钉住这三处、已发给客户。已 Rebuild。SNIPERS。）。
...
| 分支 | `main` |
| 提交 | 产品：钉住这周三处，可记已发给客户。不等客户改主题。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** `sync-from-local.ps1 -Rebuild`。`DEMO_LOGIN_ENABLED` 仍关。 |
| 接口实测 | §4.28 人测过。§4.29 待硬刷新人测。 |
| 未完成 | 人测钉住 / 已发给客户。主题改完只核 `cat_id/3`，不挡下一刀工作台。 |
| 下一台先做 | 家里先 `git pull origin main`。硬刷新人测 §4.29。不登客户机、不代改、不编问句、不抽第三轮绿联。 |
