...
最后更新：2026-08-27 18:38（公司。`526ed99` 走查已记，三地对齐发版。）。
...
| 记下没挡 | 诊断目标里还有 August Home / Level Lock / Qrio。今天先做第一件是这周三处（AI 分析建议已配置，没出现补 Fact Pack）。 |
| 仍做不到 / 不要做 | 网址过深本周做不到。llms.txt 做不到。贴上了不等于被提到。不要编问句、不要代改、不要再测客户网站、不要登 `139.129.99.194`。 |
| 下一台先做 | 海外版家里先 `git pull origin main`。对照 `docs/POSITIONING.md`。不要编 Fact Pack。 |
