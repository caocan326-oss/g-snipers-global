...
最后更新：2026-08-24 12:54（公司。产品 `e00f8d6`。§4.17 核验原话过。站外三块收工。）。
...
| 分支 | `main` |
| 提交 | 产品 `e00f8d6`。§4.15–4.17 站外三块人测过。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** 产品 `e00f8d6` 已在生产。`DEMO_LOGIN_ENABLED` 仍关。Postgres 仍不映射 5432。 |
| 接口实测 | `test_distribution` 8 通过。§4.17 核验原话过。 |
