...
最后更新：2026-08-27 10:45（公司。总览这周三处 `dbfc99b` 发版。客户改网站不是交付。）。
...
| 分支 | `main` |
| 提交 | `dbfc99b` 总览也能看见这周三处。客户改网站不是交付。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** `sync-from-local.ps1 -Rebuild`。三处 `dbfc99b`。`DEMO_LOGIN_ENABLED` 仍关。 |
| 接口实测 | §4.28、§4.29 人测过。`cat_id/3` 标记 10:32 过。打开核对不是发版挡板。 |
| 未完成 | 没有。不要等人测、不要等客户改站。 |
| 下一台先做 | 海外版家里是 `D:\workspace\G-snipers海外版`，先 `git pull origin main`。总览看这周三处。不代改、不编问句、不抽第三轮绿联。 |
