...
最后更新：2026-08-24 12:36（公司。产品 `c4944ba`。旧 451 行也带「登记≠我们代发」。§4.16 角标渠道过。）。
...
| 分支 | `main` |
| 提交 | 产品 `c4944ba`（旧 451 行也带「登记≠我们代发」，§4.17）。§4.16 角标渠道过。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** `c4944ba` 已 `sync-from-local.ps1 -Rebuild`。`DEMO_LOGIN_ENABLED` 仍关。Postgres 仍不映射 5432。 |
