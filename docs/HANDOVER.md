...
最后更新：2026-08-27 19:00（公司。Fact Pack 从资料收草稿发版供现网测。）。
...
| 分支 | `main` |
| 提交 | 产品 `c84d173`。交接随本提交。 |
| 已 push origin / upstream | 是（随本轮一起推） |
| 已发版生产 | **是。** `sync-from-local.ps1 -Rebuild`。无新迁移。现网测 Fact Pack 收草稿。不要在生产批准自己编的英文。 |
| 接口实测 | 等现网人测。中文/门锁应收不成。不批准则不出对外稿。 |
| 记下没挡 | 诊断目标里还有 August Home / Level Lock / Qrio。 |
| 仍做不到 / 不要做 | 网址过深本周做不到。llms.txt 做不到。贴上了不等于被提到。不要编问句、不要代改、不要再测客户网站、不要登 `139.129.99.194`。 |
| 下一台先做 | 现网按测试需求走人测。对照 `docs/POSITIONING.md`。不要编规格。 |
