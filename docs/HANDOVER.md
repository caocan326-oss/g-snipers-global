...
最后更新：2026-08-27 10:35（公司。§4.30 打开核对已 Rebuild。SNIPERS。）。
...
客户说改完了，经理在这周三处点「打开核对」：现抓该页，不代改。过 → 掉出这三处，钉住的补下一页。不过 → 还在，写打开过、还没过。不是这周三处不能核。`cat_id/3` 标记人眼已过；工作台这条若还记受模板限制，先取消再核。
...
| 已发版生产 | **是。** `sync-from-local.ps1 -Rebuild`。`DEMO_LOGIN_ENABLED` 仍关。 |
| 接口实测 | §4.28、§4.29 人测过。`cat_id/3` 标记 10:32 过。§4.30 待硬刷新人测。 |
| 未完成 | 人测「打开核对」。钉着的第 1 张若仍记受模板限制，先取消。 |
| 下一台先做 | 海外版家里是 `D:\workspace\G-snipers海外版`，先 `git pull origin main`。硬刷新人测 §4.30。不代改、不编问句、不抽第三轮绿联。 |
