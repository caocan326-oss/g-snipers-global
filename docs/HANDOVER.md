...
最后更新：2026-08-27 10:21（公司。§4.29 人测过。SNIPERS。）。
...
现网 JSON-LD 仍只有 name+url。经理测完可再点一次「记受模板限制」，让这周改能改的三页。主题改完再说一声，只核 `cat_id/3` 标记。**不挡我们交付工作台。**
...
| 分支 | `main` |
| 提交 | 产品仍 `f0069ca`。交接：§4.29 人测过。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** 产品未改，只同步交接。`DEMO_LOGIN_ENABLED` 仍关。 |
| 接口实测 | §4.28、§4.29 人测过。 |
| 未完成 | 主题改完只核 `cat_id/3`。不挡下一刀工作台。现网这周三处仍钉着，第 1 张已发给客户。 |
