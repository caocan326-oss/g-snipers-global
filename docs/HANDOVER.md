...
最后更新：2026-08-26 19:35（公司。§4.26 绿联 100W 抽查用量加了并切回 SNIPERS。三页核对：2/3 过，第 1 页 JSON-LD 未齐。）。
...
**生产（2026-08-26 19:35）过。** 历史网站恢复绿联，抽了那句 100W，用量加了，页头已回到 **当前客户：SNIPERS** / `https://www.snipers.com.cn`。没编问句、没代发、没停在绿联。
...
| 分支 | `main` |
| 提交 | 产品 `6b5532c`。§4.26 绿联 100W 抽查用量已加并切回 **SNIPERS**。 |
| 已 push origin / upstream | 是。 |
| 已发版生产 | **是。** 产品未改。交接随后跟上。`DEMO_LOGIN_ENABLED` 仍关。 |
| 接口实测 | 绿联 100W 联网抽查用量加了。SNIPERS 三页：2、3 过；`cat_id/3` 描述过、JSON-LD 未齐。 |
| 未完成 | `cat_id/3` 还要客户补公司/产品/认证标记。真发须客户自己的号。不要编 SNIPERS 问句。 |
| 下一台先做 | 家里先 `git pull origin main`。抽查记账已在生产踩过，不要重开。下一刀不是代发。第 1 页未齐处只回给客户，不代改。不要两边同时改。 |
