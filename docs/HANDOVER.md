...
最后更新：2026-08-22 19:18（公司。产品 `a6eebaf`。绿联身份见 §4.4。同一问三处对齐见 §4.5。）。
...
| 分支 | `main` |
| 提交 | 产品 `a6eebaf`（清单写 1/2 和 Tavily/博查）。绿联身份见 §4.4。三处对齐见 §4.5。百炼见 §4.3。运维：§4.1 / §4.2。 |
...
| 未完成 | 博查常给中文电商、没有 ugreen.com（源质量）。工作台「人工上线」不是官网已改。下一阶段：把「提到了但没官网」写成客户能改的一页。IndexNow / GSC 仍要配钥匙。不要公开注册。不要自动群发。 |
| 下一台先做 | 家里先 `git pull origin main`。强制刷新清单和客户说明：整句、标题「提到了品牌，但没给出官网」、清单有 `1 / 2` 和 Tavily/博查。不要两边同时改。家里 `localtest.db` 不要提交。 |
