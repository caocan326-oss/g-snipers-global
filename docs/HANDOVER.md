...
最后更新：2026-08-27（cloud agent。§4.24 / §4.32–4.36 / §4.45 按现行总览改过，生产未发这轮。）。
...
| 未发版（这轮） | 总览第一屏/第三块文案、总览手录框、总览「打开核对」。仓库已有，生产页还是上一轮。 |
| 仍做不到 / 不要做 | 网址过深本周做不到。llms.txt 做不到。贴上了不等于被提到。不要编问句、不要代改、不要再测客户网站、不要登 `139.129.99.194`。 |
| 下一台先做 | 审 PR。合入后 `git pull origin main`，对照 `docs/POSITIONING.md` 和 §4.45 人测。生产未 Rebuild 前不要按新文案怪现网。 |
