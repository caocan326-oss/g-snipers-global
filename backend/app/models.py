...
class BacklinkGap(Base):
    ...
    issue_type: Mapped[str] = mapped_column(String(40), default="competitor_gap")
    source: Mapped[str] = mapped_column(String(40), default="manual")
    source_platform_id: Mapped[str] = mapped_column(String(120), default="")
...
class DistributionJob(Base):
    ...
    task_type: Mapped[str] = mapped_column(String(40), default="profile_create")
    ...
    gap: Mapped[BacklinkGap | None] = relationship(back_populates="distribution_jobs")
